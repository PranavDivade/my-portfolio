...
const projects: IProjectItem[] = [
  {
    ...
    title: "Orion-AI App",
    description:
      "A Chatbot mobile application developed using Android Studio, java, Firebase Notifications.",
    icon: "/skills/android-studio-icon.svg",
    repoType: RepoType.Public,
    projectType: ProjectType.Personal,
    githubUrl: "https://github.com/PranavDivade/Orion-AI",
    url: "https://github.com/PranavDivade/Orion-AI/releases",
    tags: ["Android Studio", "Java", "Firebase Notifications"],
  },
  // {
  ...
  // },
  {
    ...
    repoType: RepoType.Public,
    projectType: ProjectType.Personal,
    githubUrl: "https://github.com/PranavDivade/my-portfolio",
    url: "https://my-portfolio-omega-fawn-89.vercel.app/",
